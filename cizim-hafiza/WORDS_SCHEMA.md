...
| Alan         | Tip    | Kural                                                             |
|--------------|--------|--------------------------------------------------------------------|
| `id`         | int    | **Tüm dosyada unique** olmalı. Yeni eklerken en yüksek id'den devam et (şu an 1–1169 kullanılı). |
...
Havuz şu an 1169 kelime (kategori başına 83–165 arası). Daha da büyütmek istersen:
